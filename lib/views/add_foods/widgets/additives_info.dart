...
import 'package:restaurant/controllers/food_controller.dart';
import 'package:restaurant/models/additives_model.dart';
                    ...
                    onTap: (){
                      if(additivePrice.text.isNotEmpty && additiveTitle.text.isNotEmpty){
                        ...
                        Get.snackbar(
                            ...
                            "You need data to add additives", "Please fill all fields");
                      }
                    },
                  ),
