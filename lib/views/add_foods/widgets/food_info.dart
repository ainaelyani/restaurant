...
import 'package:restaurant/common/custom_button.dart';
import 'package:restaurant/common/custom_textfield.dart';
          ...
          Padding(
            ...
            child: Column(
              children: [
                CustomTextfield(
                    controller: title,
                    hintText: "Title", prefixIcon: Icon(Icons.keyboard_capslock)),
                ...
                CustomTextfield(
                    ...
                    hintText: "Foods preparation time e.g 10 min", prefixIcon: Icon(Icons.keyboard_capslock)),
                SizedBox(height: 15.h,),
